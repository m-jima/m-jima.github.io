...
function bot_select_move(last_move) {
    ...
    // Find which tree the edge is in
...
var turn = {player: "blue", last_clicked: undefined, candidates: undefined, dsu: {blue: new Dsu(20), red: new Dsu(20)}, dots: create_board()};
for (let i = 0; i < 4; i++) {
...
function blue_Win_screen() {
    ...
    winMsg.style.visiblility = "visible";
